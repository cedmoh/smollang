...
mod tests {
    ...
    use ast::{
        Directives, Dyadic, DyadicOperator, Expression, Expressions,
        Identifier, IntegerLiteral, Literal, Program,
            ...
            Expressions::new(vec![
                ...
                Expression::VariableDeclaration(
                    VariableDeclarationBuilder::new(x_identifier.clone())
                        .with_initial_value(Expression::Literal(
                            Literal::Integer(IntegerLiteral::new(x_value)),
                        ))
                        .build(),
                ),
                ...
                Expression::VariableDeclaration(
                    VariableDeclarationBuilder::new(y_identifier.clone())
                        .with_initial_value(Expression::Literal(
                            Literal::Integer(IntegerLiteral::new(y_value)),
                        ))
                        .build(),
                ),
                // Add `x` and `y` together as the last expression of the
                // program, which should be returned as the
    ...
    fn should_be_able_to_use_global_variables() {
        ...
        let program = Program::new(
            Directives::default(),
            Expressions::new(vec![Expression::Identifier(Identifier::new(
                x_identifier.to_string(),
            ))]),
        );
